...
export default function Alumini(props) {
    

    return (
        <>
        <div
      class="bg-white p-6 shadow-[0_4px_12px_-5px_rgba(0,0,0,0.4)] w-full max-w-sm rounded-2xl font-[sans-serif] overflow-hidden mx-auto mt-4">
      <div class="flex flex-col items-center">
        <div class="min-h-[110px]">
          <img src='https://readymadeui.com/team-1.webp' class="w-28 h-w-28 rounded-full" />
        </div>

        <div class="mt-4 text-center">
          <p class="text-lg text-gray-800 font-bold">John Doe</p>
          <p class="text-sm text-gray-500 mt-1">Marketing Coordinator</p>
        </div>
      </div>
