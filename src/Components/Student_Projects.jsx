...
const Student_Projects = () => {
    ...
    const addInternship = async () => {
        const index = selectProject.findIndex(internship => String(internship.id) === String(internshipId));
        ...
        if (index !== -1) {
            ...
            const updatedInternships = [...selectProject];
            ...
            setIsEdit(false)
            setSelectProject(updatedInternships);
        } else {
            ...
            setSelectProject([...selectProject, newInternship]);
        }
        // closeModal();
    };
            ...
            <div>
                <div className="bg-white rounded-lg p-6 shadow-md w-[60vw]">
                    <div className="flex justify-between items-center">
                        <h2 className="text-lg font-semibold">Projects
                            Projects</h2>
                        <button
                    ...
                    <div className='mt-2'>
                        {selectProject.length === 0 ? (
                            ...
                            <div className="space-y-4">
                                {selectProject.map((internship, index) => (
                                    <div key={index} className="bg-white p-4 rounded-lg shadow-md border border-gray-200">
                                        <div className='flex gap-1 items-center'>
                                            <h3 className="text-lg font-medium text-black ">{internship.projectName}</h3>
                                            <i
                ...
                <div className="fixed inset-0 z-[80] bg-black bg-opacity-50 flex items-center justify-center">
                    <div className="bg-white border shadow-sm rounded-xl w-[70%] h-[70%] overflow-y-auto p-6">
                        ...
                        <div className='flex flex-col'>
                            <h1 className='font-medium'>Project duration</h1>
