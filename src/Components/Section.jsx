...
import { faBriefcase, faFileAlt, faHandPointer, faStar } from '@fortawesome/free-solid-svg-icons';
            ...
            <div className="flex flex-col space-y-4 py-10">
                <div className="flex gap-4 items-center">
                    <div className="bg-blue-100 rounded-full p-4">
                        <FontAwesomeIcon icon={faBriefcase} className="text-blue-500 text-xl" />
                    </div>
                    <p>{text1}</p>
                </div>
                ...
                <div className="flex  gap-4  items-center">
                    <div className="bg-blue-100 rounded-full p-4">
                        <FontAwesomeIcon icon={faHandPointer} className="text-blue-500 text-xl" />
                    </div>
                    <p>{text3}</p>
                </div>
