  ...
  return (
    <div className='flex flex-col'>
      <div className='flex flex-col justify-center items-center py-16'>
        <h1 className='text-2xl py-3 font-[Poppins]'>Showcase Your Talent, Secure a Future: <br />
          Where Top Talent Meet Top Employers</h1>
        <div className='flex gap-10 py-8'>
          <Button text="Find your next hire" className="w-72 h-20 border text-xl border-[#AAB1CE] rounded-xl" />
          <Button text="Find your next job" className="w-72 h-20 text-xl text-white bg-[#2B308B] rounded-xl" />
        </div>
      </div>
      <div className="company_information bg-[#2B308B] h-fit w-full py-32">
        <div className='flex gap-40 items-center justify-center'>
          <div className="hearders1 flex flex-col items-center gap-5">
            <h1 className='text-white text-8xl'>400+</h1>
            <p className='text-white text-xl'> Recruiters</p>
          </div>
          <div className="hearders1 flex flex-col items-center gap-5">
            <h1 className='text-white text-8xl'>6 LPA</h1>
            <p className='text-white text-xl'> Average CTC</p>
          </div>
          <div className="hearders1 flex flex-col items-center gap-5">
            <h1 className='text-white text-8xl'>32 LPA</h1>
