      ...
      <section className="py-8 px-20">
        <div className="flex justify-between">
          <div className="flex flex-col">
            ...
            <h2 className="text-3xl font-semibold mb-6 text-center">From our users</h2>
          </div>
          <div className="relative flex justify-center gap-4">
            <button
              ...
              onClick={(e) => { if (prevDisabled) e.preventDefault(); }} // Prevent click if disabled
            >
            ...
            <button
              ...
              onClick={(e) => { if (nextDisabled) e.preventDefault(); }} // Prevent click if disabled
            >
